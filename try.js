...
form.onsubmit = function (event) { return __awaiter(_this, void 0, void 0, function () {
    var formData, word, response, data, definitionList_1, error_1, resultContainer;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                event.preventDefault(); // Prevent the default form submission
                formData = new FormData(form);
                word = formData.get('defineword');
                _a.label = 1;
            case 1:
                _a.trys.push([1, 4, , 5]);
            ...
            case 3:
                data = _a.sent();
                definitionList_1 = document.querySelector('#definitionList');
                definitionList_1.innerHTML = ''; // Clear previous definitions
                data.forEach(function (wordData) {
                    wordData.meanings.forEach(function (meaning) {
                        meaning.definitions.forEach(function (definition) {
                            ...
                            definitionList_1.appendChild(li);
                        });
                    });
                });
                return [3 /*break*/, 5];
            case 4:
                ...
                resultContainer = document.querySelector('.bg-light p');
                resultContainer.textContent = 'Error fetching definition.';
                return [3 /*break*/, 5];
            case 5: return [2 /*return*/, false]; // prevent reload
        }
    });
}); };
